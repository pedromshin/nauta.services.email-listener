...
_SYSTEM_PROMPT_TEXT = (
    ...
    "- The program must be a single self-contained plain-JavaScript program — NO imports, "
    "NO require, NO JSX, NO React or any other framework.\n\n"
    ...
    "- Stay vanilla and OFFLINE: no external assets, stylesheets, fonts, or URLs. Inline "
    "any styles via element.style or a locally-created <style> element.\n\n"
    "Rules:\n"
    "- Output ONLY via the emit_code_island tool — no prose.\n"
    "- Build a concrete, complete, accessible UI that actually represents the requested "
    "interface — do NOT merely describe it and do NOT emit placeholder/meta-commentary.\n"
    "- Populate it with concise, realistic, representative content for the requested domain.\n"
