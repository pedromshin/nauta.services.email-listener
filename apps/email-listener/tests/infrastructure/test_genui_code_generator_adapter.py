...
async def test_forced_emit_code_island_tool(
    ...
    mock_bedrock_client.messages.create.return_value = _make_code_tool_response()
...
async def test_language_clamped_to_javascript(
    ...
    mock_bedrock_client.messages.create.return_value = _make_code_tool_response(language="python")
...
async def test_succeeds_on_second_attempt(
    ...
    mock_bedrock_client.messages.create.side_effect = [
        _make_no_tool_response(),
        _make_code_tool_response(),
    ]
...
async def test_all_attempts_fail_returns_fallback(
    ...
    assert mock_bedrock_client.messages.create.call_count == 3
...
async def test_empty_code_string_triggers_fallback(
    ...
    mock_bedrock_client.messages.create.return_value = _make_code_tool_response(code="   ")
