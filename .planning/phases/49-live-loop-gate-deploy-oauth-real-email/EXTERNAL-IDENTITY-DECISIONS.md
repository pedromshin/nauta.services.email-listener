...
|---|---|---|---|---|
| GitHub repo rename (`pedromshin/nauta.services.email-listener` -> `polytoken.services.email-listener`) | EXECUTE | Low risk in isolation — GitHub auto-redirects old clone/fetch/push URLs (runbook Sec 1) | **User checkpoint (49-06)**, NOT autonomous — see OIDC coupling below | Held for 49-06 |
